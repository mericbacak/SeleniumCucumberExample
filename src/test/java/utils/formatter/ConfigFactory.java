...
public class ConfigFactory {
    ...
    protected static void configureBuildNumber(@NotNull final Configuration configuration, @NotNull final Properties properties) {
        configuration.setBuildNumber(properties.getProperty("buildNumber"));
    }

    protected static void configureSortingMethod(final Configuration configuration, @NotNull final Properties properties) {
    ...
    protected static void configureTagsToExcludeFromChart(@NotNull final Configuration configuration, final Properties properties) {
        final String[] tagsToExclude = getTagsToExcludeFromChart(properties);
        configuration.setTagsToExcludeFromChart(tagsToExclude);
    }
    @NotNull
    protected static String[] getTagsToExcludeFromChart(@NotNull final Properties properties) {
    ...
    protected static void configureTrendsStatsFile(final Configuration configuration, @NotNull final Properties properties) {
    ...
    protected static void configureRepeatableConfigurationKeys(final Configuration configuration, @NotNull final Properties properties) {
    ...
    protected static void configurePresentationMode(final String qualifiedKey, final Configuration configuration, @NotNull final Properties properties) {
    ...
    protected static void configureReducingMethod(final String qualifiedKey, final Configuration configuration, @NotNull final Properties properties) {
        if (parseBoolean(properties.getProperty(qualifiedKey))) {
